...
st.title("🔧 Optimasi Produksi - Jumlah Mesin & Operator")

st.markdown("""
Aplikasi ini menghitung penjualan, keuntungan, dan total operator yang dibutuhkan berdasarkan jumlah produk, mesin, dan operator per mesin.
...
\]
\[
\text{Total Operator Dibutuhkan} = (\text{Mesin Produk}_1 + \dots + \text{Mesin Produk}_n) \times \text{Operator per Mesin}
\]
""")
...
# Input jumlah operator per mesin
...
total_operator = total_mesin * operator_per_mesin

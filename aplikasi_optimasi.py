...
st.title("🔧 Optimasi & Analisis Produksi - Mesin & Operator")
...
if all(laba > 0 for laba in laba_per_unit) and total_operator_tersedia > 0:
    ...
    st.info("ℹ️ Masukkan data produk dan total operator yang tersedia untuk melihat hasil optimasi.")
